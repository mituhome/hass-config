...
warn ""
warn "mituhome.vn modified version 03 Sep 2020"
...
URL_UPDATER="https://raw.githubusercontent.com/mituhomevn/hass-config/master/hassio_installer.sh/updater.json"
# Check env
...
if [ -z "${HOMEASSISTANT_DOCKER}" ]; then
    ...
    error "https://mituhome.vn/home-assistant/home-assistant-cai-dat-tren-docker-2020-03-20#ftoc-chay-script-cai-dat-voi-tuy-chon"
fi
...
echo "[Info] Modified by mituhome.vn"
